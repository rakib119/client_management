...
if (isset($_GET['task']) && $_GET['task'] == "update") {
    $id = $_GET['id'];
    $old_services = mysqli_fetch_assoc(select("services", "*", "id='$id'"));
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                                ...
                                                <form id="edit_service" method="POST" action="service-action.php" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-select selectcat" name="categories" id="categories_id" aria-label="Default select example" onchange="categoriesid(this.value)">
                                                                        ...
                                                                        ?>
                                                                                <option value="<?= $row['id']; ?>" <?= ($row['id'] == $old_services['categories_id']) ? "selected" : "" ?>> <?= $row['category_name']; ?></option>
                                                                        <?php
                                                                            }
                                                                        } else {
                                                                    ...
                                                                    <p id="wrrongtextselectcatsms" class="wrrongtext hide">please select a category</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-select selectsubcat" name="subcategories_id" id="subcategories_id" aria-label="Default select example">
                                                                        <option value="">No Data Found</option>
                                                                        <?php
                                                                        foreach (select("sub_categories", "*", "categories_id= '$old_cat_id' and status=1") as  $sub_cat) { ?>
                                                                            <option value="<?= $sub_cat['id']; ?>" <?= ($sub_cat['id'] == $old_services['subcategories_id']) ? "selected" : "" ?>> <?= $sub_cat['subcategory_name']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control service_name servicename" value="<?= $old_services['service_name']; ?>" name="service_name" id="progress-basicpill-phoneno-input">
                                                                ...
                                                                <p id="wrrongtextservicenamesms" class="wrrongtext hide">please enter service name name</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control service_amount" value="<?= $old_services['service_amount']; ?>" name="service_amount" id="progress-basicpill-phoneno-input">
                                                    ...
                                                    <div class="row hide">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="progress-basicpill-phoneno-input">Price Categories <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control price_categories" value="<?= $old_services['price_categories']; ?>" name="price_categories" id="progress-basicpill-phoneno-input">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control price_unit" value="<?= $old_services['price_unit']; ?>" name="price_unit" id="progress-basicpill-phoneno-input">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 hide">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="progress-basicpill-phoneno-input">Price Unit Amount <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control price_unit_amount" value="<?= $old_services['price_unit_amount']; ?>" name="price_unit_amount" id="progress-basicpill-phoneno-input">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" class="form-control serviceimg" name="image">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="mb-12">
                                                                <label class="form-label" for="progress-basicpill-phoneno-input">Details <span class="text-danger">*</span></label>
                                                                <textarea name="service_details" class="form-control servicedetails" id="" cols="30" rows="4"><?= $old_services['service_details']; ?> </textarea>
